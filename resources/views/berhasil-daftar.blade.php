...
<div class="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 via-white to-yellow-100 py-8">
    <div class="bg-white p-8 rounded-2xl shadow-2xl max-w-lg w-full border border-blue-100 text-center">
        ...
        <p class="mb-6 text-gray-700">Kamu telah terdaftar menjadi murid Educaty.<br>Pelajari lebih lanjut fitur-fitur Educaty.</p>
        <a href="/fasilitas" class="inline-block px-8 py-3 bg-gradient-to-r from-blue-500 to-yellow-400 text-white rounded-lg font-bold text-lg shadow hover:from-blue-600 hover:to-yellow-500 transition">Fasilitas</a>
    </div>
</div>
@endsection
